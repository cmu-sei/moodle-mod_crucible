...
$string['configbulkdeploywaittimeout'] = 'Maximum number of minutes to wait for each user event to become active during a sequential bulk deployment. If the event does not become active in time, Moodle starts the next selected user and continues checking the launched event in the background. The user is marked failed only if Alloy reports that the event failed or ended. Defaults to 10 minutes. Values outside 1 to 60 minutes are constrained to that range.';
...
$string['extendeventsetting_help'] = 'Setting this allows the user to extend the lab by the configured interval.';
$string['extendinterval'] = 'Extend interval';
$string['extendinterval_help'] = 'Number of minutes to add when the event is extended.';
